...
class HelpContent {
  static const Map<String, List<HelpEntry>> pages = {
    ...
    'sensors': [
      ...
      HelpEntry('Sorting and hiding',
          'Use the chips at the top: sort battery-related first (default), hottest first, or by name. "Hide 0°" and "Hide 90°+" filter out dead or garbage readings some phones report.'),
    ...
    'battery': [
      ...
      HelpEntry('Battery health (estimate)',
          'Set your phone\'s design capacity (mAh, from the specs) with the ✎ button. While monitoring records a charge session, the app measures mAh charged vs % gained and estimates the real full capacity. Health % = estimated ÷ design capacity. Needs at least one recorded session of 15 % or more — it is an estimate, not a lab measurement.'),
      HelpEntry('Charging current',
          'Negative values usually mean discharging. Many phones report 0 while idle — that is normal. When discharging, the absolute discharge current is shown.'),
    ],
    'apps': [
    ...
    'stats': [
      ...
      HelpEntry('Reading exact values',
          'Press and drag on any graph to see the exact value and time at that point.'),
      HelpEntry('Customize',
